...
async function main() {
  ...
  try {
    ...
    let timestamp = await contract.timestamp();
    console.log("timestamp() output: ", timestamp.toString());
    console.log(`Calling sender()`);
    let sender = await contract.sender();
    console.log("sender() output: ", sender.toString());
